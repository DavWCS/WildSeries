...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    const PROGRAM = [
        ...
        ['Title' => 'American Horror Story', 'Synopsys' => 'American Horror Story nous embarque dans des récits à la fois poignants et cauchemardesques.', 'Category' => 'category_Fantastic'],
