...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    const PROGRAM = [
        ...
        'synopsys' => 'Tandis que des kaijus surgis de l\'océan envahissent l\'Australie, un ado et sa petite sœur pilotent un Jaeger cabossé pour rechercher leurs parents disparus.', 'Category' => 'category_Animation']
    ];
