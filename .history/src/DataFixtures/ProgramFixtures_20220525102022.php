...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    const PROGRAM = [
        ...
        ['Title' => 'Pacific Rim: The Black', 'Synopsys' => 'Tandis que des kaijus surgis de locéan envahissent l'Australie, un ado et sa petite sœur pilotent un Jaeger cabossé pour rechercher leurs parents disparus.', 'Category' => 'category_Animation'],
    ];
